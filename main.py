...
import ipaddress
from exchange.utility.LogMaker import send_telegram_message 
...
async def startup():
    log_message(f"Hello World!:{VERSION}")
    send_telegram_message(f"Hello World!:{VERSION}")
...
async def validation_exception_handler(request, exc):
    ...
    log_validation_error_message(f"{exc.body}")
